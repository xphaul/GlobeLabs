...
<module external.linked.project.id=":react-native-maps" external.linked.project.path="$MODULE_DIR$" external.root.project.path="$MODULE_DIR$/../../example/android" external.system.id="GRADLE" external.system.module.group="android" external.system.module.version="unspecified" type="JAVA_MODULE" version="4">
  ...
  <component name="NewModuleRootManager" LANGUAGE_LEVEL="JDK_1_7" inherit-compiler-output="false">
    ...
    <content url="file://$MODULE_DIR$">
      ...
      <excludeFolder url="file://$MODULE_DIR$/build/intermediates/exploded-aar/com.facebook.react/react-native/0.27.0-rc1/jars" />
    ...
    <orderEntry type="library" exported="" name="react-native-0.27.0-rc1" level="project" />
